...
set_property PACKAGE_PIN N17 [get_ports sig]
set_property PACKAGE_PIN AN0 [get_ports rst]
set_property PACKAGE_PIN CA [get_ports A]
set_property PACKAGE_PIN CB [get_ports B]
set_property PACKAGE_PIN CC [get_ports C]
set_property PACKAGE_PIN CD [get_ports D]
set_property PACKAGE_PIN CE [get_ports E]
set_property PACKAGE_PIN CF [get_ports F]
set_property PACKAGE_PIN CG [get_ports G]
